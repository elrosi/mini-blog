<x-app-layout
    :title="$post->title"
    :meta-description="__('Edit post')">
    <h1 class="my-4 font-serif text-3xl text-center text-sky-600 dark:text-sky-500">{{ __('Edit form') }}</h1>

    <form class="max-w-xl px-8 py-4 mx-auto mb-8 bg-white rounded shadow dark:bg-slate-800"
